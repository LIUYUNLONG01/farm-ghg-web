    ...
    <main className="min-h-screen flex">
      ...
      <div className="w-full lg:w-[520px] flex flex-col items-center justify-center px-6 sm:px-12 bg-white relative">
        ...
        <div className="w-full max-w-sm relative z-10">
          ...
          <h2 className="text-2xl font-bold text-gray-900 tracking-tight mb-1">注册账号</h2>
          <p className="text-sm text-gray-400 mb-8">需要邀请码才能注册</p>

          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-[13px] font-semibold text-gray-600 mb-1.5 tracking-wide">邀请码</label>
            ...
            <div>
              <label className="block text-[13px] font-semibold text-gray-600 mb-1.5 tracking-wide">姓名（选填）</label>
              <div className="relative group">
                <div className="absolute left-3.5 top-1/2 -translate-y-1/2 text-gray-300 group-focus-within:text-green-500 transition-colors">
                  <UserIcon />
                </div>
            ...
            <div>
              <label className="block text-[13px] font-semibold text-gray-600 mb-1.5 tracking-wide">邮箱地址</label>
              <div className="relative group">
                <div className="absolute left-3.5 top-1/2 -translate-y-1/2 text-gray-300 group-focus-within:text-green-500 transition-colors">
                  <MailIcon />
                </div>
            ...
            <div>
              <label className="block text-[13px] font-semibold text-gray-600 mb-1.5 tracking-wide">密码</label>
              <div className="relative group">
                <div className="absolute left-3.5 top-1/2 -translate-y-1/2 text-gray-300 group-focus-within:text-green-500 transition-colors">
                  <LockIcon />
                </div>
